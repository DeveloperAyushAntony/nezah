        ...
        <section className={`relative min-h-[85vh] flex items-center justify-center pt-20 transition-colors duration-500 ${isDark ? 'bg-background-dark' : 'bg-white-soft'}`}>
            ...
            <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                ...
                >
                    ...
                    <h1 className={`font-serif text-7xl md:text-9xl font-bold mb-6 tracking-tight ${isDark ? 'text-white' : 'text-primary'}`}>
                        Nezah <span className={`${isDark ? 'text-accent' : 'purple-text-gradient'} italic`}>Designs</span>
                    </h1>

                    <p className={`text-xl md:text-2xl mb-12 tracking-[0.2em] uppercase font-light ${isDark ? 'text-white/70' : 'text-primary/70'}`}>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        ...
                        <button className={`btn-outline min-w-[240px] ${!isDark ? 'border-primary/20 text-primary hover:bg-primary hover:text-white' : ''}`}>
                            Book Consultation
                        </button>
                    </div>
                </motion.div>
